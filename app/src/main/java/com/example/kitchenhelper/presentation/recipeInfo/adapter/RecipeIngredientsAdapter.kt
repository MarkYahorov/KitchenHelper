package com.example.kitchenhelper.presentation.recipeInfo.adapter
...
class RecipeIngredientsAdapter(private val glide: RequestManager) :
    ListAdapter<Ingredient, RecipeIngredientsAdapter.IngredientsViewHolder>(DiffCallback()) {
